...
const Register = ({setIsAuthenticated}) => { 
    ...
    return ( 
        ...
        <form class="w-full max-w-sm bg-slate-300 shodow-xl rounded-xl p-5 mt-20 "noValidate no-autocomplete onSubmit={handleSubmit}>
          <h1 className="text-2xl text-teal-500 text-center mb-6  font-bold">Register</h1>
          ...
          <div class="md:flex md:items-center mb-6">   
            ...
            <div class="md:w-2/3">
              <input autoComplete="off" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-green-700" id="email" type="text" name="email"  placeholder="cellie@gmail.com" required/>
            </div>
          </div>
          <div class="md:flex md:items-center mb-6">
            <div class="md:w-1/3">
